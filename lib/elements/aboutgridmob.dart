...
class StaggeredGridPageMob extends StatefulWidget {
  @override
  State<StaggeredGridPageMob> createState() => _StaggeredGridPageState();
}

class _StaggeredGridPageState extends State<StaggeredGridPageMob> {
  late ConfettiController _confettiController; // Declare ConfettiController

  final String viewUrl =
      "https://drive.google.com/file/d/1d1A4LzA-yRyRpjcvcxDlzIqxJkR_AzWD/view";
  final String downloadUrl =
      "https://drive.google.com/uc?export=download&id=1d1A4LzA-yRyRpjcvcxDlzIqxJkR_AzWD";
